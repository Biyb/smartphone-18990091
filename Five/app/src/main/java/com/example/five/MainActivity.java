...
import com.example.five.bean.UserInfo;
import com.example.five.database.UserDBHelper;
import com.example.five.util.DateUtil;
import com.example.five.util.ViewUtil;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    // 初始化用户类型的下拉框
    private String[] typeArray = {"个人用户", "公司用户","学校用户", "18990091-毕竞之"};
