...
public class GoodsInfo {
    ...
    private static String[] stagTitleArray = {
            "古风珐琅玉兰耳坠", "小蜜蜂花朵耳坠", "ZENGLIU流苏耳坠",
            "晶柜韩国长款耳饰", "Olady雏菊长款耳饰", "CAROMAY四叶草耳坠",
            "DINGMG宴会流苏耳饰", "Enternelle流苏耳坠", "亭亭玉立长款耳坠",
            "OSEWA花朵蝴蝶耳饰", "独角兽小众耳饰", "CAROY相思红豆耳坠",
            "SCIAL长款碧悠耳坠", "YINCHE星星流苏耳坠", "心草樱桃长款耳线",
            "CROAY闪亮皇冠耳环", "SPCIAL古陌花影耳饰", "WEALTO高级感耳环",
            "CARMY圆圈气质耳环", "CAROY个性夸张耳环", "韩国紫色长款耳坠",
            "OSA蝴蝶结长款耳坠", "YGR夸张高级耳饰"};
